...
QT_MOC_LITERAL(1, 9, 11), // "updateChart"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14) // "QList<QPointF>"

    },
    "Graphics\0updateChart\0\0QList<QPointF>"
};
...
void Graphics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateChart((*reinterpret_cast< QList<QPointF>(*)>(_a[1]))); break;
        default: ;
        }
