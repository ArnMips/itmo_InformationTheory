...
public:
    ...
    {
        MyForm->setWindowTitle(QApplication::translate("MyForm", "Graph", Q_NULLPTR));
        label_3->setText(QApplication::translate("MyForm", "Entropy value", Q_NULLPTR));
        label_2->setText(QApplication::translate("MyForm", "Distribution histogram ", Q_NULLPTR));
        label->setText(QApplication::translate("MyForm", "Signal graph", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tb1Signal), QApplication::translate("MyForm", "Signal", Q_NULLPTR));
        label_4->setText(QApplication::translate("MyForm", "Gaussian noise graph", Q_NULLPTR));
        label_5->setText(QApplication::translate("MyForm", "Distribution histogram ", Q_NULLPTR));
        label_6->setText(QApplication::translate("MyForm", "Entropy value", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tb2Noise), QApplication::translate("MyForm", "Gaussian noise", Q_NULLPTR));
        label_10->setText(QApplication::translate("MyForm", "Convolution", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tb3Convolution), QApplication::translate("MyForm", "Convolution", Q_NULLPTR));
        label_9->setText(QApplication::translate("MyForm", "Entropy value", Q_NULLPTR));
        label_8->setText(QApplication::translate("MyForm", "Distribution histogram ", Q_NULLPTR));
        label_7->setText(QApplication::translate("MyForm", "Signal + noise graph", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tb4SignalNoise), QApplication::translate("MyForm", "Signal + noise", Q_NULLPTR));
    } // retranslateUi
